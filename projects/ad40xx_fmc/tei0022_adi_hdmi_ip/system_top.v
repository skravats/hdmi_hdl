...
module system_top (
  ...
  // yuv 422, embedded sync, ddr clk, style 2, table 21, 720p, hdmi_clk 74.25M
  ...
  assign hdmi_vsync = 1'b0; 
    ...
    ddr8 (
	.aclr(1'b0),
	.outclock(hdmi_clk_shifted),
	.datain_l(crcb),
    .datain_h(y),
    .dataout(hdmi_data[7:0])
  );
  
  
  assign hdmi_data [23:8] = {16{1'b0}};
  ...
  system_bd i_system_bd (
    ...
    .hdmi_out_h16_vsync (),
    .hdmi_out_h16_data_e (),
    .hdmi_out_h16_es_data ({crcb, y}),
	.hdmi_clk_shifted_clk (hdmi_clk_shifted));	
